...
const Navbar = () => {
  ...
  return (
    <div>
      <nav className="fixed lg:top-[68px] xl:top-10 top-0 left-0 w-full bg-white dark:bg-white z-40" style={{ boxShadow: '0px 25px 20px -20px rgba(0,0,0,0.45)' }}>
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto px-4 py-2 dark:text-white">
          ...
          <div
            ...
            id="navbar-sticky"
          >
            <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-white dark:text-black">
              <li>
                <Link
                  href="/"
