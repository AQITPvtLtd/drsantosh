  ...
  return (
    <div className="py-16 lg:px-12 px-2">
      <div className="lg:p-10 p-8 border-none shadow-custom-inset rounded-3xl">
        <div className="border-solid border-2 border-black rounded-3xl lg:p-8 p-4 grid grid-cols-1 lg:grid-cols-12 gap-8">
          {/* Image Section */}
          <div className="lg:col-span-6 flex flex-col items-center lg:items-start">
            ...
            />
            <h1 className="text-4xl font-bold mt-4 mb-4 text-gray-800 lg:ml-24 lg:text-left lg:block hidden">
              Dr. Santosh Ghai
            </h1>
          </div>
          ...
          <div className="lg:col-span-6 lg:mt-16">
            <h1 className="lg:text-5xl sm:text-2xl text-2xl sm:text-center font-bold mb-4 text-center text-[#07a496] underline leading-snug lg:text-left font-serif">
              Dr. Santosh Ghai
            </h1>
            <div className="text-lg space-y-2 ">
              <p className="font-semibold lg:text-3xl text-xl text-[#07a496]">
